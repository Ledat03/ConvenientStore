...
public class VNPayService {
    public String createPaymentURL(HttpServletRequest req, Payment payment, Delivery delivery, User user) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String orderType = "other";
        int totalAmount = payment.getAmount().multiply(BigDecimal.valueOf(100)).intValue();
